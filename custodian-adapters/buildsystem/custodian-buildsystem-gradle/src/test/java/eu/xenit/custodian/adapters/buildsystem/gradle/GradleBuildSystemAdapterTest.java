...
public class GradleBuildSystemAdapterTest {
    ...
    public void testInvokeGradle() throws IOException, BuildSystemException {
        ...
        GradleBuildSystemAdapter analyzer = new GradleBuildSystemAdapter(
                new DefaultGradleBuildFactory(),
    ...
    public void verifyReportParserIsCalled() {
        ...
        GradleBuildSystemAdapter analyzer = new GradleBuildSystemAdapter(new DefaultGradleBuildFactory(), parser,
                GradleRunner::create);
