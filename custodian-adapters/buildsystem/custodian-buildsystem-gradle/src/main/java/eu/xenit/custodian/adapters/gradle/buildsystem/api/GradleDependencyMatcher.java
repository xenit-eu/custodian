...
import static eu.xenit.custodian.adapters.gradle.buildsystem.api.GradleDependencyMatcher.Util.doesNotMatch;

import eu.xenit.custodian.adapters.gradle.buildsystem.api.notation.GradleArtifactStringNotationParser;
...
public interface GradleDependencyMatcher extends DependencyMatcher<GradleDependency> {
    ...
    static GradleDependencyMatcher from(GradleModuleDependency dependency) {
        return from(null, String.format("%s:%s:%s", dependency.getGroup(), dependency.getId(),
