...
import eu.xenit.custodian.adapters.gradle.buildsystem.api.RemoteRepository;
import eu.xenit.custodian.adapters.gradle.buildsystem.spi.sentinel.dto.Dependency;
